...
export const languages = {
  zh: {
    ...
    login: {
      eyebrow: 'Login',
      title: '登录 ZenMind',
      intro: '输入邮箱即可登录或注册。验证码会发送到你的邮箱，登录状态由安全 Cookie 保存。',
      formTitle: '邮箱验证码登录',
      emailLabel: '邮箱',
      codeLabel: '6 位验证码',
  ...
  en: {
    ...
    login: {
      ...
      intro: 'Enter your email to sign in or create an account. We will send a verification code and keep your session in a secure cookie.',
